...
func TestExtractTemplateVersionListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Extract.Templates.Versions.List(
		...
		githubcomnimblewaynimblego.ExtractTemplateVersionListParams{
...
func TestExtractTemplateVersionGet(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Extract.Templates.Versions.Get(
		...
		githubcomnimblewaynimblego.ExtractTemplateVersionGetParams{
