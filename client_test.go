...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.Extract.Run(context.Background(), githubcomnimblewaynimblego.ExtractRunParams{
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Extract.Run(context.Background(), githubcomnimblewaynimblego.ExtractRunParams{
		URL: "https://exapmle.com",
	})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Extract.Run(cancelCtx, githubcomnimblewaynimblego.ExtractRunParams{
		URL: "https://exapmle.com",
	})
	if err == nil {
		t.Error("Expected there to be a cancel error")
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Extract.Run(deadlineCtx, githubcomnimblewaynimblego.ExtractRunParams{
			URL: "https://exapmle.com",
		})
		if err == nil {
