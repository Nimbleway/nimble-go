...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Extract.Extract(context.Background(), githubcomnimblewaynimblego.ExtractExtractParams{
		URL: "url",
	})
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Extract.Extract(context.Background(), githubcomnimblewaynimblego.ExtractExtractParams{
		URL: "url",
	})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Extract.Extract(cancelCtx, githubcomnimblewaynimblego.ExtractExtractParams{
		URL: "url",
	})
	if err == nil {
		t.Error("Expected there to be a cancel error")
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Extract.Extract(deadlineCtx, githubcomnimblewaynimblego.ExtractExtractParams{
			URL: "url",
		})
		if err == nil {
