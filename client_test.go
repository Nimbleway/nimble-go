...
import (
	...
	"github.com/Nimbleway/nimbleway-go/internal"
...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Extract(context.Background(), nimbleway.ExtractParams{
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Extract(context.Background(), nimbleway.ExtractParams{
		DebugOptions: nimbleway.ExtractParamsDebugOptions{},
		URL:          "https://example.com",
	})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Extract(cancelCtx, nimbleway.ExtractParams{
		DebugOptions: nimbleway.ExtractParamsDebugOptions{},
		URL:          "https://example.com",
	})
	if err == nil {
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Extract(deadlineCtx, nimbleway.ExtractParams{
			DebugOptions: nimbleway.ExtractParamsDebugOptions{},
			URL:          "https://example.com",
		})
		if err == nil {
