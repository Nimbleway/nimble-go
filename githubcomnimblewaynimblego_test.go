...
func TestExtractWithOptionalParams(t *testing.T) {
	...
	_, err := client.Extract(context.TODO(), githubcomnimblewaynimblego.ExtractParams{
		DebugOptions: githubcomnimblewaynimblego.ExtractParamsDebugOptions{
			CollectHar: githubcomnimblewaynimblego.ExtractParamsDebugOptionsCollectHarUnion{
				OfBool: githubcomnimblewaynimblego.Bool(true),
			},
			NoRetryMode: githubcomnimblewaynimblego.ExtractParamsDebugOptionsNoRetryModeUnion{
				OfBool: githubcomnimblewaynimblego.Bool(true),
			},
			RecordScreen: githubcomnimblewaynimblego.ExtractParamsDebugOptionsRecordScreenUnion{
				OfBool: githubcomnimblewaynimblego.Bool(true),
			},
			Redact: githubcomnimblewaynimblego.ExtractParamsDebugOptionsRedactUnion{
				OfBool: githubcomnimblewaynimblego.Bool(true),
			},
			ShowCursor: githubcomnimblewaynimblego.ExtractParamsDebugOptionsShowCursorUnion{
				OfBool: githubcomnimblewaynimblego.Bool(true),
			},
			SolveCaptcha: githubcomnimblewaynimblego.ExtractParamsDebugOptionsSolveCaptchaUnion{
				OfBool: githubcomnimblewaynimblego.Bool(true),
			},
			Trace: githubcomnimblewaynimblego.ExtractParamsDebugOptionsTraceUnion{
				OfBool: githubcomnimblewaynimblego.Bool(true),
			},
			UploadEngineLogs: githubcomnimblewaynimblego.ExtractParamsDebugOptionsUploadEngineLogsUnion{
				OfBool: githubcomnimblewaynimblego.Bool(true),
			},
			Verbose: githubcomnimblewaynimblego.ExtractParamsDebugOptionsVerboseUnion{
				OfBool: githubcomnimblewaynimblego.Bool(true),
			},
			WithProxyUsage: githubcomnimblewaynimblego.ExtractParamsDebugOptionsWithProxyUsageUnion{
				OfBool: githubcomnimblewaynimblego.Bool(true),
			},
		},
...
func TestExtractTemplate(t *testing.T) {
	...
	_, err := client.ExtractTemplate(context.TODO(), githubcomnimblewaynimblego.ExtractTemplateParams{
		Params: map[string]any{
			"foo": "bar",
		},
		Template: "template",
