...
func TestAgentTemplateListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Agents.Templates.List(context.TODO(), githubcomnimblewaynimblego.AgentTemplateListParams{
...
func TestAgentTemplateGet(t *testing.T) {
	...
	_, err := client.Agents.Templates.Get(context.TODO(), "template_name")
	if err != nil {
		var apierr *githubcomnimblewaynimblego.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
